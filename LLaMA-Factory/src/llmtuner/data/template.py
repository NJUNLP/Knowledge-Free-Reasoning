...
_register_template(
    name="dictalm2",
    # <s> is only appended in the first turn in this prompt, don't use for multi-turn
...
_register_template(
    name="llama2_simp_cot_en",
    format_user=StringFormatter(slots=[{"bos_token"}, "[INST] {{content}} [/INST] Let's think step by step."]),
    format_system=StringFormatter(slots=["<<SYS>>\n{{content}}\n<</SYS>>\n\n"]),
    default_system="You are a helpful assistant.",
)
...
_register_template(
    name="llama2_simp_cot_zh",
    format_user=StringFormatter(slots=[{"bos_token"}, "[INST] {{content}} [/INST] 让我们一步一步来。"]),
    format_system=StringFormatter(slots=["<<SYS>>\n{{content}}\n<</SYS>>\n\n"]),
    default_system="You are a helpful assistant.",
)
